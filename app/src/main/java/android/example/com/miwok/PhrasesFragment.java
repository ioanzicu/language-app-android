...
public class PhrasesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        words.add(new Word("Where are you going?", "Wo gehst du hin?", R.raw.phrase_where_are_you_going));
        words.add(new Word("What is your name?", "Wie heißen Sie?", R.raw.phrase_what_is_your_name));
        words.add(new Word("My name is...", "Ich heiße...", R.raw.phrase_my_name_is));
        words.add(new Word("How are you feeling?", "Wie geht es dir?", R.raw.phrase_how_are_you_feeling));
