...
public class FamilyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        words.add(new Word("father", "Vater (der)", R.drawable.family_father, R.raw.family_father));
        words.add(new Word("mother", "Mutter (die)", R.drawable.family_mother, R.raw.family_mother));
        words.add(new Word("son", "Sohn (der)", R.drawable.family_son, R.raw.family_son));
        words.add(new Word("daughter", "Tochter (die)", R.drawable.family_daughter, R.raw.family_daughter));
        ...
        words.add(new Word("grandmother", "Oma (die)", R.drawable.family_grandmother, R.raw.family_grandmother));
        words.add(new Word("grandfather", "Opa (der)", R.drawable.family_grandfather, R.raw.family_grandfather));
